...
TRANSLATE_PROMPT = """
用户将提供给你 Mastering Ethereum: 2nd Edition 书中的某一章节的 markdown内容，请你将内容翻译成中文，注意只做翻译，不要删减内容，不要添加解释和演绎。
输出格式保持 markdown 格式。

你必须严格遵循以下规则：
1. 遇到一些暂时没有合适翻译的专业术语时，保留英文原文，例如 Zk-Rollup 
...
class LLMTranslator:
    ...
    def simple_translate(self, text):
        system_prompt = "你是一个精通中文的与英文的以太坊技术专家，请将以下英文内容翻译成中文，仅返回翻译后的中文内容，不要添加任何解释。"
