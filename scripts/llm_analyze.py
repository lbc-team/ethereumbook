...
from config import  OPENROUTER_PREFIX, DEEPSEEK_MODEL_NAME_PREFIX, LLM_MODEL_GPT_4O_MINI, VOLC_LLM_MODEL_DEEPSEEK_R1, VOLC_LLM_MODEL_DEEPSEEK_V3, ALIYUN_LLM_MODEL_DEEPSEEK_R1, ALIYUN_LLM_MODEL_DEEPSEEK_V3, MAX_TOKENS
...
def analyze_article(markdown_text, model=OPENROUTER_MODEL_GEMINI_20_FLASH):
    ...
    system_prompt = """
你是编程及区块链技术专家，用户将提供给你一段 "Mastering Ethereum: 2nd Edition" 书中的某一章节的 markdown 内容，请你总结内容，并提取其中的关键词：
